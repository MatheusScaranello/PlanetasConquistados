  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.planet}>
        <Title style={styles.planetName} title={data.name} />
        <Text style={styles.detail}>Date of Conquest: {data.dateOfConquist}</Text>
        <Text style={styles.detail}>Population: {data.population}</Text>
        <Text style={styles.detail}>Natural Resources: {data.naturalResources}</Text>
        <Text style={styles.detail}>Number of Human Settlements: {data.numberHumanSettlements}</Text>
